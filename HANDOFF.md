...
| 45b | (текущий) | fix: сортировка по doc_date + LIMIT 20000 |
...
- Карточка инвентаризации: pager/prev/next/Печать — ЗАКРЫТО в Этапе 40.
  Осталось: кнопки Изменить / Создать документ / табы Связанные документы / Задачи / Файлы — заглушки.
- Документы: карточка DocumentCardView.vue реализована (Этап 41).
...
A) ЗАКРЫТО в Этапе 42 — кнопки Изменить/Создать документ/Задачи/Файлы
   убраны, добавлена генерация writeoff/receipt из коррекций инвентаризации.
   Хвост: таб «Связанные документы» — заглушка.
