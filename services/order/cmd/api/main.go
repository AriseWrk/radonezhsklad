...
read.GET("/customers/:id", h.GetCustomer)
			read.GET("/contracts", h.ListContracts)
			read.GET("/contracts/:id", h.GetContract)
			read.GET("/contracts/:id/neighbors", h.ContractNeighbors)
...
write.POST("/customers", h.CreateCustomer)
			write.PUT("/customers/:id", h.UpdateCustomer)
			write.POST("/contracts", h.CreateContract)
			write.PUT("/contracts/:id", h.UpdateContract)
			write.DELETE("/contracts/:id", h.DeleteContract)
