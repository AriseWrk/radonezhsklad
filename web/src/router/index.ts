...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'inventories', name: 'inventories', component: () => import('../views/InventoriesView.vue'), meta: { roles: ['admin', 'manager', 'warehouse'] }, },
      { path: 'inventories/:id', name: 'inventory-card', component: () => import('../views/InventoryCardView.vue'), meta: { roles: ['admin', 'manager', 'warehouse'] }, },
