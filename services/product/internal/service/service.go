...
if err != nil {
return nil, apperr.Internal("get category", err)
}
if c == nil {
...
if err != nil {
return nil, apperr.Internal("update category", err)
}
if c == nil {
return nil, apperr.NotFound("category not found")
}
...
if err != nil {
return apperr.Internal("delete category", err)
}
if !ok {
...
func (s *Service) ListUnits(ctx context.Context) ([]models.Unit, error) {
...
return nil, apperr.Conflict("product with this SKU already exists")
}
...
if err != nil {
return nil, apperr.Internal("get product", err)
}
if p == nil {
...
if err != nil {
return apperr.Internal("archive product", err)
}
if !ok {
