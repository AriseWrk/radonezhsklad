...
c := &models.Contract{
Number: r.Number,
Amount: r.Amount, Paid: r.Paid, Fulfilled: r.Fulfilled,
Currency: r.Currency, Archived: r.Archived,
}
...
if r.DocDate != "" {
if t, err := time.Parse("2006-01-02T15:04:05Z07:00", r.DocDate); err == nil {
c.DocDate = t
